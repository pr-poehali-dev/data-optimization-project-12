...
export default function Index() {
  ...
  return (
    <main className="relative h-screen w-full overflow-hidden bg-background">
      ...
      >
        <img
          src="https://cdn.poehali.dev/projects/6aa484ae-9e0d-4763-b9e2-55d4013903e4/bucket/3256d388-7a86-44c4-b093-02f3e73d4913.png"
          alt="TARGET PROM GLOBAL специалист"
      ...
      >
        ...
        <div className="hidden items-center gap-8 md:flex">
          {["Главная", "Работы", "Услуги", "О нас", "Новости", "Контакты"].map((item, index) => (
            <button
              key={item}
        ...
        <section className="flex min-h-screen w-screen shrink-0 flex-col justify-end px-6 pb-16 pt-24 md:px-12 md:pb-24">
          <div className="max-w-3xl">
            <div className="mb-4 inline-block animate-in fade-in slide-in-from-bottom-4 rounded-full border border-foreground/20 bg-foreground/15 px-4 py-1.5 backdrop-blur-md duration-700">
              <p className="font-mono text-xs text-foreground/90">Россия · Турция · Китай</p>
            </div>
            <h1 className="mb-6 animate-in fade-in slide-in-from-bottom-8 font-sans text-6xl font-light leading-[1.1] tracking-tight text-foreground duration-1000 md:text-7xl lg:text-8xl">
              <span className="text-balance">
                Упаковочное оборудование премиум-класса
              </span>
            </h1>
            <p className="mb-8 max-w-xl animate-in fade-in slide-in-from-bottom-4 text-lg leading-relaxed text-foreground/90 duration-1000 delay-200 md:text-xl">
              <span className="text-pretty">
                Поставляем лучшее упаковочное оборудование от ведущих производителей трёх стран. Надёжность, качество и индивидуальный подход для вашего производства.
              </span>
            </p>
